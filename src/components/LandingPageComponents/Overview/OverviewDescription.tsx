...
export default function OverviewDescription(props: any) {
  const overviewData: OverviewDataRequest = props.requestedOverviewData
    ? props.requestedOverviewData
    : {
        year: props.fallbackData.frontmatter.year,
        topic: props.fallbackData.frontmatter.topic1,
        excerpt: props.fallbackData.frontmatter.topic1excerpt,
      }
  ...
  return (
    <OverviewDescriptionWrapper>
      <h1 style={{ textAlign: "right", flex: 0.1 }}>
        {overviewData.topic} | {overviewData.year}{" "}
      </h1>
