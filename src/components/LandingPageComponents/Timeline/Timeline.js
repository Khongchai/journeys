...
import handleTimelineMove, {
  adjustElementsSizeOnResize,
} from "./utils/handleTimelineMove"
...
export default function Timeline(props) {
  ...
  const frontmatterData = useRef(
    query.allMdx.edges.map(edge => edge.node.frontmatter)
  )
  ...
  function setOverviewDataAndBlackBackgroundHeight(
    year,
    topic,
    excerpt,
    picture
  ...
  return (
    <>
      ...
      <HideTimeline
        id="hide-timeline-text"
        onClick={() => hideTimeline(setHideNavBarToggle, hideNavBarToggle)}
      >
        Hide Timeline
      </HideTimeline>
            ...
            return (
              <>
                <span
                  ...
                  className="event"
                  onClick={() =>
                    setOverviewDataAndBlackBackgroundHeight(
                      data.year,
                      data.topic1,
                      data.topic1excerpt,
                      data.featureImageI
                        ? data.featureImageI.childImageSharp.fluid
                        : null
                    )
                  }
                >
                ...
                {!data.topic2 ? (
                  <span
                    role="presentation"
                    className="event empty-placeholder"
                    style={{ display: "none" }}
                  ></span>
                ) : (
                  <span
                    ...
                    onClick={() =>
                      setOverviewDataAndBlackBackgroundHeight(
                        ...
                        data.topic2excerpt,
                        data.featureImageII
                          ? data.featureImageII.childImageSharp.fluid
                          : null
                      )
                    }
                    className="event"
                  ...
                  <span
                    ...
                    onClick={() =>
                      setOverviewDataAndBlackBackgroundHeight(
                        ...
                        data.topic3,
                        data.topic3excerpt,
                        data.featureImageIII
                          ? data.featureImageIII.childImageSharp.fluid
                          : null
                      )
                    }
                    className="event"
