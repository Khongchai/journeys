...
<div style={{ textAlign: "center" }}>Analysis</div>
...
<em class="image-caption">
  The accompaniment for the 3rd measure of the theme later in the movement.
</em>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={eighthImg} />
  <img class="enlargeable adjacent" src={ninthImg} />
</span>
...
<strong id="Russian Music">Russian Music</strong>
...
<img
  class="enlargeable adjacent-small"
  src={tenthImg}
  style={{ float: "right" }}
/>
...
<em class="image-caption center">
  The introduction of the folk song Во поле береза стояла on solo oboe and
  bassoon.
</em>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={thirteenthImg} />
  <img class="enlargeable adjacent" src={fourteenImg} />
</span>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={sixteenthImg} />
  <img class="enlargeable adjacent" src={seventeenthImg} />
</span>
...
<strong id="Glinka's Karaminskaya">Glinka's Karaminskaya</strong>
...
<strong id="Comparisons">Comparisons</strong>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={twentiethImg} />
  <img class="enlargeable adjacent" src={twentyFirstImg} />
</span>
...
<em class="image-caption">
  Hundreds of measures later, the theme is still repeating itself in the same
  form.
</em>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={twentyThirdImg} />
  <img class="enlargeable adjacent" src={twentyFourthImg} />
</span>
<em class="image-caption center">
  Left: Violin I and Violin II; Right: Viola and Cello
</em>
...
This one does not require many assumptions as we know for a fact that he used music from this Ukraine, also known as Little Russia, in his 2nd symphony, Little Russian. We’ll pick Журавель (The Crane), included in his 2nd symphony; and Ніч яка місячна (Moonlit Night), another famous Ukrainian folk song.

<div id="The Craneparagraph">

<strong id="The Crane">The Crane</strong>
...
<div id="Moonlit Nightparagraph">

<strong id="Moonlit Night">Moonlit Night</strong>
...
<strong id="Ukraine Conclusion">Ukraine Conclusion</strong>
...
<strong id="The Young Maiden Walked So Far">
  The Young Maiden Walked So Far
</strong>

<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={twentySeventhImg} />
  <img class="enlargeable adjacent" src={twentyEighthImg} />
</span>
...
<strong id="Korobeiniki">Korobeiniki</strong>
...
<strong id="Russia Conclusion">Russia Conclusion</strong>
...
<strong id="Unknown Italian Folk Song">Unknown Italian Folk Song</strong>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={thirtyFirstImg} />
  <img class="enlargeable adjacent" src={thirtySecondImg} />
</span>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={thirtyThirdImg} />
  <img class="enlargeable adjacent" src={thirtyFourthImg} />
</span>
...
<strong id="Tarantella Napoletana">Tarantella Napoletana</strong>

<img
  class="enlargeable half-width"
  src={thirtyFifthImg}
...
<strong id="Italy Conclusion">Italy Conclusion</strong>
...
<em class="image-caption">
  Reduction of the first theme from Neue Wiener for flute, Bb clarinet, and
  bassoon.
</em>

<div id="Neue Wienerparagraph">

<strong id="Neue Wiener">Neue Wiener</strong>
...
<span class="adjacent-images-container">
  <img class="enlargeable adjacent" src={thirtySeventhImg} />
  <img class="enlargeable adjacent" src={thirtyEighthImg} />
</span>
...
<strong id="The Foregoing Waltz">The Foregoing Waltz</strong>
...
<strong id="Alpine Conclusion">Alpine Conclusion</strong>
